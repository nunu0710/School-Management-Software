...
while True:
    ...
    def teachers_create():
        ...
        teachers_dict = {"first_name" : first_name, "last_name": last_name, "class_name": class_name}
    ...
    def homeroom_teacher_mgmt():
        homeroomTeacher = input("Enter the home room teacher please> ")
        for homeRoomTeacher in database["homeroom_teachers"]:
           if homeRoomTeacher["first_name"] == homeroomTeacher:
                    print (f"Students led by {homeRoomTeacher["first_name"]} are :") 
        for student in database["students"]:
